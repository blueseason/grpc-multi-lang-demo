...
func (x *HelloNumReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HelloNumReq) ProtoMessage() {}

func (x *HelloNumReq) ProtoReflect() protoreflect.Message {
	mi := &file_helloworld_helloworld_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HelloNumReq.ProtoReflect.Descriptor instead.
func (*HelloNumReq) Descriptor() ([]byte, []int) {
	return file_helloworld_helloworld_proto_rawDescGZIP(), []int{2}
}

func (x *HelloNumReq) GetNum() int32 {
	if x != nil {
		return x.Num
	}
	return 0
...
func (x *HelloNumRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HelloNumRes) ProtoMessage() {}

func (x *HelloNumRes) ProtoReflect() protoreflect.Message {
	mi := &file_helloworld_helloworld_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HelloNumRes.ProtoReflect.Descriptor instead.
func (*HelloNumRes) Descriptor() ([]byte, []int) {
	return file_helloworld_helloworld_proto_rawDescGZIP(), []int{3}
}

func (x *HelloNumRes) GetNum() int32 {
	if x != nil {
		return x.Num
	}
	return 0
...
var file_helloworld_helloworld_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x1f, 0x0a, 0x0b, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x4e, 0x75,
	0x6d, 0x52, 0x65, 0x71, 0x12, 0x10, 0x0a, 0x03, 0x6e, 0x75, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x22, 0x1f, 0x0a, 0x0b, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x4e,
	0x75, 0x6d, 0x52, 0x65, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x6e, 0x75, 0x6d, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x32, 0xa7, 0x02, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65,
	...
	0x79, 0x22, 0x00, 0x12, 0x4b, 0x0a, 0x13, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53,
	...
	0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x41,
	0x0a, 0x0b, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x4e, 0x75, 0x6d, 0x12, 0x17, 0x2e,
	0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	0x4e, 0x75, 0x6d, 0x52, 0x65, 0x71, 0x1a, 0x17, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f,
	0x72, 0x6c, 0x64, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x4e, 0x75, 0x6d, 0x52, 0x65, 0x73, 0x22,
	0x00, 0x42, 0x4d, 0x0a, 0x1b, 0x69, 0x6f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x65, 0x78, 0x61,
	...
	0x6f, 0x50, 0x01, 0x5a, 0x15, 0x67, 0x6f, 0x5f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f,
...
var file_helloworld_helloworld_proto_goTypes = []interface{}{
	...
	(*HelloNumReq)(nil),  // 2: helloworld.HelloNumReq
	(*HelloNumRes)(nil),  // 3: helloworld.HelloNumRes
}
var file_helloworld_helloworld_proto_depIdxs = []int32{
	...
	2, // 3: helloworld.Greeter.SayHelloNum:input_type -> helloworld.HelloNumReq
	...
	1, // 6: helloworld.Greeter.SayHelloBidiStream:output_type -> helloworld.HelloReply
	3, // 7: helloworld.Greeter.SayHelloNum:output_type -> helloworld.HelloNumRes
