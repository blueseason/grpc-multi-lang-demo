...
type GreeterClient interface {
	...
	SayHelloNum(ctx context.Context, in *HelloNumReq, opts ...grpc.CallOption) (*HelloNumRes, error)
}
...
func (c *greeterClient) SayHelloNum(ctx context.Context, in *HelloNumReq, opts ...grpc.CallOption) (*HelloNumRes, error) {
	out := new(HelloNumRes)
	err := c.cc.Invoke(ctx, "/helloworld.Greeter/SayHelloNum", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	...
	SayHelloNum(context.Context, *HelloNumReq) (*HelloNumRes, error)
...
func (UnimplementedGreeterServer) SayHelloNum(context.Context, *HelloNumReq) (*HelloNumRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayHelloNum not implemented")
}
...
func _Greeter_SayHelloNum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloNumReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).SayHelloNum(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.Greeter/SayHelloNum",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).SayHelloNum(ctx, req.(*HelloNumReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SayHelloNum",
			Handler:    _Greeter_SayHelloNum_Handler,
		},
	},
